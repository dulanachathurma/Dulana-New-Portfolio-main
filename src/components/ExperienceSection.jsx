...
const experiences = [
{
    ...
    description: "Active student member of the IEEE Sri Lanka Section with ID <strong>102613884</strong>, engaging in professional networks and technical community initiatives.",
