            ...
            >
              <div>
                ...
                <div className="flex items-center gap-5 mb-8">
                  <div className="w-16 h-16 rounded-[1.5rem] overflow-hidden border border-black/5 dark:border-white/10">
                ...
                {/* Metadata */}
                <div className="flex flex-wrap items-center gap-4 text-xs text-[#86868b] font-medium border-t border-gray-100 dark:border-[#262626] pt-6 mb-8">
              ...
              <div>
                ...
                <div className="flex flex-wrap gap-2">
                  {edu.skills.map((skill, idx) => (
                    <span 
                      key={idx} 
                      className="px-3 py-1 text-[11px] font-medium rounded-lg bg-gray-100 dark:bg-[#1a1a1a] text-[#424245] dark:text-[#a1a1a6] border border-transparent"
                    >
                      {skill}
                    </span>
                  ))}
